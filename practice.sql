...
INNER JOIN(
	...
	INNER JOIN
		countrylanguages
	ON
		PER.country_code = countrylanguages.country_code AND
		PER.percentage = countrylanguages.percentage) AS lang
ON
	NAME.country_code = lang.country_code
;
...
ON
	countries.code = ave.country_code
ORDER BY
	ave.A DESC
;
